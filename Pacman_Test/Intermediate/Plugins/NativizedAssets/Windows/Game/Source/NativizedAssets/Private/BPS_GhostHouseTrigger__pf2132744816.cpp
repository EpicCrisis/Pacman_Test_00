...
#include "BPS_GhostHouseTrigger__pf2132744816.h"
...
ABPS_GhostHouseTrigger_C__pf2132744816::ABPS_GhostHouseTrigger_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABPS_GhostHouseTrigger_C__pf2132744816::StaticClass() == GetClass()))
	{
		ABPS_GhostHouseTrigger_C__pf2132744816::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
...
void ABPS_GhostHouseTrigger_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABPS_GhostHouseTrigger_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABPS_GhostHouseTrigger_C__pf2132744816::bpf__ExecuteUbergraph_BPS_GhostHouseTrigger__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	bool  __Local__1 = false;
	if (!((::IsValid(b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf)) ? (b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf->bpv__isDeadx__pfzy) : (__Local__1)))
	{
		return; //KCST_GotoReturnIfNot
	}
	bpfv__CallFunc_K2_SetTimer_ReturnValue__pf = UKismetSystemLibrary::K2_SetTimer(b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf, FString(TEXT("Reset")), 0.200000, false);
	if(::IsValid(b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf))
	{
		b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf->bpv__BackToNormalTimerHandle__pf = bpfv__CallFunc_K2_SetTimer_ReturnValue__pf;
	}
	return; // KCST_GotoReturn
}
void ABPS_GhostHouseTrigger_C__pf2132744816::bpf__ReceiveActorBeginOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_BPS_GhostHouseTrigger__pf_0(1);
}
void ABPS_GhostHouseTrigger_C__pf2132744816::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void ABPS_GhostHouseTrigger_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABPS_GhostHouseTrigger_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{50, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.TimerHandle 
		...
		{90, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Pacman_Test.GhostHouseTrigger 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABPS_GhostHouseTrigger_C__pf2132744816
{
	FRegisterHelper__ABPS_GhostHouseTrigger_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/BPS_GhostHouseTrigger"), &ABPS_GhostHouseTrigger_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABPS_GhostHouseTrigger_C__pf2132744816 Instance;
};
FRegisterHelper__ABPS_GhostHouseTrigger_C__pf2132744816 FRegisterHelper__ABPS_GhostHouseTrigger_C__pf2132744816::Instance;
