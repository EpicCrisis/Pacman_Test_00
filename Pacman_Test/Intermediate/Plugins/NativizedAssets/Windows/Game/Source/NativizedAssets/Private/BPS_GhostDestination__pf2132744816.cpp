...
ABPS_GhostDestination_C__pf2132744816::ABPS_GhostDestination_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABPS_GhostDestination_C__pf2132744816::StaticClass() == GetClass()))
	{
		ABPS_GhostDestination_C__pf2132744816::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__BillboardxRoot__pfT = CreateDefaultSubobject<UBillboardComponent>(TEXT("Billboard Root"));
	bpv__Trigger__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("Trigger"));
	RootComponent = bpv__BillboardxRoot__pfT;
	bpv__BillboardxRoot__pfT->CreationMethod = EComponentCreationMethod::Native;
	if(!bpv__BillboardxRoot__pfT->IsTemplate())
	{
		bpv__BillboardxRoot__pfT->BodyInstance.FixupData(bpv__BillboardxRoot__pfT);
	}
	bpv__Trigger__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Trigger__pf->AttachToComponent(bpv__BillboardxRoot__pfT, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__0 = (*(AccessPrivateProperty<FVector >((bpv__Trigger__pf), UBoxComponent::__PPO__BoxExtent() )));
	__Local__0 = FVector(50.000000, 50.000000, 300.000000);
	if(!bpv__Trigger__pf->IsTemplate())
	{
		bpv__Trigger__pf->BodyInstance.FixupData(bpv__Trigger__pf);
	}
	bpv__isTaken__pf = false;
	bpv__GameModeRef__pf = nullptr;
	bpv__CurrentBlock__pf = nullptr;
}
PRAGMA_ENABLE_OPTIMIZATION
void ABPS_GhostDestination_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
	if(bpv__BillboardxRoot__pfT)
	{
		bpv__BillboardxRoot__pfT->CreationMethod = EComponentCreationMethod::Native;
	}
	if(bpv__Trigger__pf)
...
PRAGMA_DISABLE_OPTIMIZATION
void ABPS_GhostDestination_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABPS_GhostDestination_C__pf2132744816::bpf__ExecuteUbergraph_BPS_GhostDestination__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	int32 bpfv__CallFunc_RandomIntegerInRange_ReturnValue1__pf{};
	...
	do
	{
		...
		case 5:
			{
				int32  __Local__4 = 0;
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(((::IsValid(bpv__GameModeRef__pf)) ? (bpv__GameModeRef__pf->bpv__MaxY__pf) : (__Local__4)), 1);
				...
				int32  __Local__5 = 0;
				bpfv__CallFunc_Subtract_IntInt_ReturnValue1__pf = UKismetMathLibrary::Subtract_IntInt(((::IsValid(bpv__GameModeRef__pf)) ? (bpv__GameModeRef__pf->bpv__MaxX__pf) : (__Local__5)), 1);
				bpfv__CallFunc_RandomIntegerInRange_ReturnValue1__pf = UKismetMathLibrary::RandomIntegerInRange(0, bpfv__CallFunc_Subtract_IntInt_ReturnValue1__pf);
				if(::IsValid(bpv__GameModeRef__pf))
				{
					bpv__GameModeRef__pf->bpf__GetBlockFromGridLocation__pf(bpfv__CallFunc_RandomIntegerInRange_ReturnValue1__pf, bpfv__CallFunc_RandomIntegerInRange_ReturnValue__pf, /*out*/ b0l__CallFunc_GetBlockFromGridLocation_BlockActor__pf);
				}
			}
		case 6:
			{
				bool  __Local__6 = false;
				if (!((::IsValid(b0l__CallFunc_GetBlockFromGridLocation_BlockActor__pf)) ? (b0l__CallFunc_GetBlockFromGridLocation_BlockActor__pf->bpv__isWalkable__pf) : (__Local__6)))
				{
					__CurrentState = 8;
					break;
				}
		...
		case 7:
			{
				if(::IsValid(b0l__CallFunc_GetBlockFromGridLocation_BlockActor__pf))
				{
					bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = b0l__CallFunc_GetBlockFromGridLocation_BlockActor__pf->AActor::K2_GetActorLocation();
				}
				bpfv__CallFunc_K2_SetActorLocation_ReturnValue__pf = AActor::K2_SetActorLocation(bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetActorLocation_SweepHitResult__pf, true);
				__CurrentState = -1;
				break;
			}
		case 8:
...
void ABPS_GhostDestination_C__pf2132744816::bpf__ExecuteUbergraph_BPS_GhostDestination__pf_1(int32 bpp__EntryPoint__pf)
{
	bool bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 13);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf = Cast<ABPS_GhostCharacter_C__pf2132744816>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
	...
	ABPS_GhostDestination_C__pf2132744816*  __Local__7 = ((ABPS_GhostDestination_C__pf2132744816*)nullptr);
	bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(((::IsValid(b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf)) ? (b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf->bpv__CurrentTargetTrigger__pf) : (__Local__7)), this);
	...
	{
		b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf->bpv__CurrentTargetTrigger__pf = ((ABPS_GhostDestination_C__pf2132744816*)nullptr);
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf))
	{
		b0l__K2Node_DynamicCast_AsBPS_Ghost_Character__pf->bpf__FindNextDestination__pf();
	}
	// optimized KCST_UnconditionalGoto
	bpf__Randomize__pf();
	return; // KCST_GotoReturn
}
void ABPS_GhostDestination_C__pf2132744816::bpf__ExecuteUbergraph_BPS_GhostDestination__pf_2(int32 bpp__EntryPoint__pf)
{
...
void ABPS_GhostDestination_C__pf2132744816::bpf__ExecuteUbergraph_BPS_GhostDestination__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 12);
	return; // KCST_GotoReturn
}
void ABPS_GhostDestination_C__pf2132744816::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BPS_GhostDestination__pf_2(17);
}
void ABPS_GhostDestination_C__pf2132744816::bpf__BndEvt__Trigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_BPS_GhostDestination__pf_1(13);
}
void ABPS_GhostDestination_C__pf2132744816::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BPS_GhostDestination__pf_3(12);
}
void ABPS_GhostDestination_C__pf2132744816::bpf__Randomize__pf()
{
	bpf__ExecuteUbergraph_BPS_GhostDestination__pf_0(2);
}
void ABPS_GhostDestination_C__pf2132744816::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void ABPS_GhostDestination_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABPS_GhostDestination_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{68, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, true, false)},  //  Class /Script/Engine.BillboardComponent 
		{69, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Texture2D /Engine/EditorResources/S_Actor.S_Actor 
		...
		{72, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.PrimitiveComponent 
		...
		{73, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Pacman_Test.GhostDestination 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABPS_GhostDestination_C__pf2132744816
{
	FRegisterHelper__ABPS_GhostDestination_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/BPS_GhostDestination"), &ABPS_GhostDestination_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABPS_GhostDestination_C__pf2132744816 Instance;
};
FRegisterHelper__ABPS_GhostDestination_C__pf2132744816 FRegisterHelper__ABPS_GhostDestination_C__pf2132744816::Instance;
